...
function AddNewCoursePage() {
    ...
    const {courseCurriculumFormData,courseLandingFormData, setCourseCurriculumFormData, setCourseLandingFormData,currentEditedCourseId, setCurrentEditedCourseId} = useContext(InstructorContext);
